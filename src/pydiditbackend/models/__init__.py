...
projects_contain_projects = Table(
    'projects_contain_projects', Base.metadata,
...
projects_contain_todos = Table(
    'projects_contain_todos', Base.metadata,
    Column('project_id', Integer(), ForeignKey('projects.id'), nullable=False),
    Column('todo_id', Integer(), ForeignKey('todos.id'), nullable=False),
    PrimaryKeyConstraint('project_id', 'todo_id'),
)

projects_prereq_projects = Table(
    'projects_prereq_projects', Base.metadata,
    Column('project_id', Integer, ForeignKey('projects.id'), nullable=False),
    Column('prereq_id', Integer, ForeignKey('projects.id'), nullable=False),
    PrimaryKeyConstraint('project_id', 'prereq_id'),
)

projects_prereq_todos = Table(
    'projects_prereq_todos', Base.metadata,
    Column('project_id', Integer(), ForeignKey('projects.id'), nullable=False),
    Column('todo_id', Integer(), ForeignKey('todos.id'), nullable=False),
    PrimaryKeyConstraint('project_id', 'todo_id'),
)

todos_prereq_projects = Table(
    'todos_prereq_projects', Base.metadata,
    Column('todo_id', Integer, ForeignKey('todos.id'), nullable=False),
    Column('project_id', Integer, ForeignKey('projects.id'), nullable=False),
    PrimaryKeyConstraint('todo_id', 'project_id')
)

todos_prereq_todos = Table(
    'todos_prereq_todos', Base.metadata,
    Column('todo_id', Integer(), ForeignKey('todos.id'), nullable=False),
    Column('prereq_id', Integer(), ForeignKey('todos.id'), nullable=False),
    PrimaryKeyConstraint('todo_id', 'prereq_id'),
)

projects_notes = Table(
    'projects_notes', Base.metadata,
    Column('project_id', Integer(), ForeignKey('projects.id'), nullable=False),
